...
PhotoBoothTheme neobrutalismTheme({required Color primaryColor}) => PhotoBoothTheme(
...
final _dialogTitleStyle = GoogleFonts.spaceMono(fontSize: 28, fontWeight: FontWeight.w600);
...
final _captureCounterTextStyle = GoogleFonts.rubikMonoOne(color: Colors.white, fontSize: 280);
