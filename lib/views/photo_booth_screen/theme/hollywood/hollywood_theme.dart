...
final _rootTextStyle = GoogleFonts.limelight(
  shadows: [BoxShadow(color: Color.fromARGB(255, 0, 0, 0), offset: Offset(2, 4), blurRadius: 8)],
...
final _dialogTitleStyle = GoogleFonts.limelight(fontSize: 32);
