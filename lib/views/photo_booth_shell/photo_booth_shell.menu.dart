      ...
      child: MenuBar(
        items: [
          MenuBarItem(title: localizations.genericFile, items: [
            ...
            MenuFlyoutItem(text: Text(localizations.genericSettings), onPressed: () { context.router.push(SettingsRoute()); }, leading: Icon(LucideIcons.settings), trailing: _shortcut("Ctrl+S")),
          ...
          MenuBarItem(title: localizations.genericView, items: [
            ...
            const MenuFlyoutSeparator(),
            MenuFlyoutItem(text: Text(localizations.screensStart), onPressed: () { context.router.replaceAll([StartRoute()]); }, leading: Icon(LucideIcons.play), trailing: _shortcut("Ctrl+H")),
            MenuFlyoutItem(text: Text(localizations.screensGallery), onPressed: () { context.router.replaceAll([GalleryRoute()]); }, leading: Icon(LucideIcons.images)),
            MenuFlyoutItem(text: Text(localizations.screensManualCollage), onPressed: () { context.router.replaceAll([ManualCollageRoute()]); }, leading: Icon(LucideIcons.layoutDashboard), trailing: _shortcut("Ctrl+M")),
          ]),
          MenuBarItem(title: localizations.genericHelp, items: [
            ...
            MenuFlyoutItem(text: Text(localizations.genericAbout), onPressed: () { context.router.push(SettingsRoute(initialPage: SettingsPageKey.about)); }, leading: Icon(LucideIcons.info)),
          ]),
        ],
      ),
    );
