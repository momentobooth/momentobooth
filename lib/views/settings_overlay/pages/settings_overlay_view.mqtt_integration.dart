...
Widget _getMqttIntegrationSettings(SettingsOverlayViewModel viewModel, SettingsOverlayController controller) {
  return SettingsPage(
...
Widget _getConnectionBlock(SettingsOverlayViewModel viewModel, SettingsOverlayController controller) {
...
Widget _getClientBlock(SettingsOverlayViewModel viewModel, SettingsOverlayController controller) {
  return SettingsSection(
    title: "Client",
    settings: [
      SettingsTextEditTile(
...
Widget _getHomeAssistantBlock(SettingsOverlayViewModel viewModel, SettingsOverlayController controller) {
  return SettingsSection(
